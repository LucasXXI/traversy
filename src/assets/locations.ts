export const locations: Location[] = [
  ...
  },
  {
    ...
    description: "O Parque Zoobotânico é uma unidade de conservação do Museu Paraense Emílio Goeldi, que abriga uma ampla variedade de espécies de animais e plantas da Amazônia. O local também conta com um centro de pesquisas científicas e programas de educação ambiental.",
    imageUrl: "https://www.turismoparaense.com/wp-content/uploads/2018/11/Em%C3%ADlio-Goeldi-1.jpg",
    price: 5,
    openingHours: "Aberto de terça a domingo, das 9h às 16h30",
    address: "Av. Magalhães Barata, 376 - São Braz, Belém - PA, 66040-170",
  ...
  },
  {
    ...
    description: "O Museu da Imagem e do Som do Pará é um espaço dedicado à preservação, pesquisa e difusão do acervo audiovisual e fotográfico paraense. O museu conta com exposições permanentes e temporárias, além de exibições de filmes e eventos culturais.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Mispa3.jpg/1280px-Mispa3.jpg",
    price: 5,
    openingHours: "Aberto de terça a sexta, das 10h às 16h; sábados, das 10h às 14h",
  ...
  },
  {
    ...
    description: "A Catedral Metropolitana de Belém, também conhecida como Basílica de Nossa Senhora de Nazaré, é uma das principais igrejas católicas da cidade. Sua arquitetura neoclássica é imponente e inspiradora, e o interior é rico em detalhes e obras de arte sacra.",
    imageUrl: "https://www.turismoparaense.com/wp-content/uploads/2019/04/igreja-da-se-catedral-metropolitana-2-830x467.jpg",
    price: 0,
  ...
  },
  {
    ...
    description: "A Ilha de Cotijuba é uma das maiores ilhas do arquipélago de Belém, localizada a cerca de 2 horas de barco da cidade. O local é conhecido por suas belas praias, natureza preservada e ambiente tranquilo. É um destino ideal para quem quer relaxar e aproveitar a natureza.",
    imageUrl: "https://www.guiaviagensbrasil.com/blog/wp-content/uploads/2020/02/cotijuba-ilha-belem.jpg",
    price: 60,
    openingHours: "A ilha pode ser visitada a qualquer hora, mas é recomendado ir durante o dia.",
